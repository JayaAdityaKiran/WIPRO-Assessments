...
import com.example.SpringBookMvcThymeleafApplication;
...
public class HomeController {
    ...
    private final SpringBookMvcThymeleafApplication springBootMvcThymeleafApplication;
	
	@Autowired
	public UserService userService;

	HomeController(SpringBookMvcThymeleafApplication springBootMvcThymeleafApplication) {
	 ...
	 //and bind this with the variables as username and password which is of String type
	    ...
	    public String showServicePage(HttpServletRequest req, Model model) {
	        ...
	        if (session != null && session.getAttribute("username") != null) {
	            model.addAttribute("username", session.getAttribute("username"));
	            return "success";  // Show service.html
	        }
