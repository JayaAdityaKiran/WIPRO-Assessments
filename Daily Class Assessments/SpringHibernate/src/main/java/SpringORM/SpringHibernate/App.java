package SpringORM.SpringHibernate;
...
import SpringORM.SpringHibernate.Util.HibernateUtil;
import SpringORM.SpringHibernate.model.Student;
...
public class App 
{
	...
	public static void main( String[] args )
    {
	   ...
	   Student s1 = new Student("Jaya Aditya","tjak@gmail" , "hibernatecourse");
